...
OWNER: str = os.environ.get("LEGALIZE_OWNER", "legalize-kr")

#: Repository holding Korean laws as Markdown (author-dated commits).
LAWS_REPO: str = os.environ.get("LEGALIZE_LAWS_REPO", "legalize-kr")

#: Repository holding Korean court precedents as Markdown + metadata.json.
PRECEDENTS_REPO: str = os.environ.get("LEGALIZE_PRECEDENTS_REPO", "precedent-kr")

#: Default branch used by both mirror repos.
DEFAULT_BRANCH: str = os.environ.get("LEGALIZE_BRANCH", "main")
